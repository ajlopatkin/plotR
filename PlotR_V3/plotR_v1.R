...
server <- function(input, output,session) {
  ...
  observeEvent(data(),{
    ...
    updateSelectInput(session, "X_axis2", choices=colnames(read_excel(data()$datapath[2])))
    updateSelectInput(session, "Y_axis2", choices=colnames(read_excel(data()$datapath[2])))
    updateSelectInput(session, "fill_var12", choices=colnames(read_excel(data()$datapath[2])))
    updateSelectInput(session, "facetVarX2", choices=colnames(read_excel(data()$datapath[2])))
    updateSelectInput(session, "facetVarY2", choices=colnames(read_excel(data()$datapath[2])))
    updateSelectInput(session, "annoRow", choices=colnames(read_excel(data()$datapath[2])))
    updateSelectInput(session, "anno1", choices=colnames(read_excel(data()$datapath[2])))
    
    updateSelectInput(session, "X_axis3", choices=colnames(read_excel(data()$datapath[3])))
    updateSelectInput(session, "Y_axis3", choices=colnames(read_excel(data()$datapath[3])))
    updateSelectInput(session, "fill_var13", choices=colnames(read_excel(data()$datapath[3])))
    updateSelectInput(session, "facetVarX3", choices=colnames(read_excel(data()$datapath[3])))
    updateSelectInput(session, "facetVarY3", choices=colnames(read_excel(data()$datapath[3])))
     
    updateSelectInput(session, "X_axis4", choices=colnames(read_excel(data()$datapath[4])))
    updateSelectInput(session, "Y_axis4",  choices=colnames(read_excel(data()$datapath[4])))
    updateSelectInput(session, "fill_var14",  choices=colnames(read_excel(data()$datapath[4])))
    updateSelectInput(session, "facetVarX4",  choices=colnames(read_excel(data()$datapath[4])))
    updateSelectInput(session, "facetVarX42",  choices=colnames(read_excel(data()$datapath[4])))
    updateSelectInput(session, "facetVarY4",  choices=colnames(read_excel(data()$datapath[4])))
    updateSelectInput(session, "discreteGroup",  choices=colnames(read_excel(data()$datapath[4])))
    updateSelectInput(session, "avgGroup",  choices=colnames(read_excel(data()$datapath[4])))
  })
  ...
  observeEvent(input$plotScat,{
    ...
    df1<- read_excel(data()$datapath[4])
    
    if(input$showSD ==1){
      output$sd <- renderPrint({
        apply(read_excel(data()$datapath[4]), 2, sd)
      })
    }
  ...
  observeEvent(input$plotHist,{
    ...
    #df<- read_excel(data()[[3, 'datapath']])
    #df<- read_excel(data()$datapath[3])
